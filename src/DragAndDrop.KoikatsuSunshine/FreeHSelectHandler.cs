...
namespace DragAndDrop
{
    internal class FreeHSelectHandler : CardHandlerMethods
    {
        ...
        private const string ThreesomeMaleCanvas = "FreeHScene/Canvas/Panel/3P/main/MaleCard";
        private const string ThreesomeFemaleCanvas = "FreeHScene/Canvas/Panel/3P/main/FemaleCard";
        private const string Stage1Canvas = "FreeHScene/Canvas/Panel/3P/main/Stage1";
